...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='mmMobileViT_Track', help='training script name')
...
if __name__ == "__main__":
    ...
    if args.script == "mmMobileViT_Track":
        model_module = importlib.import_module('lib.models')
        model_constructor = model_module.build_mmMobileViT_Track
