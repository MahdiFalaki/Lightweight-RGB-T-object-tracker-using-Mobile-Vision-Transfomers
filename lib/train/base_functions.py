...
def get_optimizer_scheduler(net, cfg):
    """ Configures optimizer with different LR scaling for backbone & mmMobileViT_Track parameters. """
    ...
    param_dicts = [
        {
            "params": [],
            "param_names": [],
            "lr": cfg.TRAIN.LR  # Full LR (default)
        },
        {
            "params": [],
            "param_names": [],
            "lr": cfg.TRAIN.LR * cfg.TRAIN.BACKBONE_MULTIPLIER  # Scaled LR for Backbone
        }
    ]
    ...
    for n, p in net.named_parameters():
        if p.requires_grad:
            if "backbone" in n:
                # Backbone params get reduced LR
                param_dicts[1]["params"].append(p)
                param_dicts[1]["param_names"].append(n)
            else:
                # other params get full LR
                param_dicts[0]["params"].append(p)
                param_dicts[0]["param_names"].append(n)
